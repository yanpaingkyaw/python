...
time.sleep(2)
#click reportTab
lnkReport = driver.find_element_by_xpath('//*[@id="main-menu-left"]/li[4]/a')
lnkReport.click()
time.sleep(2)
#GeneralTab
lnkGeneraltab = driver.find_element_by_xpath('//*[@id="main"]/div[2]/div/div/div/div/div/div/ul/li[5]/a')
lnkGeneraltab.click()
time.sleep(2)
#searchReport
txtsearchrpt = driver.find_element_by_xpath('//*[@id="main"]/div[2]/div/div/div/div/div/div/div/div[5]/div/input')
txtsearchrpt.send_keys('HANA - DailyClosure Status')
time.sleep(2)
#clicksearch result report
lnkQResult = driver.find_element_by_xpath('//*[@id="main"]/div[2]/div/div/div/div/div/div/div/div[5]/div/table/tbody/tr/td[2]') 
lnkQResult.click()
time.sleep(2)
#click run report
